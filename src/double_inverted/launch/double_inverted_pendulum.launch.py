"""Launch file for the double inverted pendulum. GIVEN -- do not modify.
...
def launch_setup(context, *args, **kwargs):
    pkg_share = get_package_share_directory('double_inverted')
    ...
    xacro_file = os.path.join(pkg_share, 'urdf', 'double_pendulum.urdf.xacro')
    ...
    nodes = [
        ...
        Node(
            ...
            remappings=[('joint_states', '/double_inverted/joint_states')],
        ),
    ]
...
def generate_launch_description():
    return LaunchDescription([
        ...
        DeclareLaunchArgument('ic_mode', default_value='downward',
                               description='upright | downward | random'),
